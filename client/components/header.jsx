      ...
      <Navbar collapseOnSelect className="color-nav" expand="md" sticky="top" >
        <Container fluid >
          ...
          <Navbar.Offcanvas id="offcanvasNavbar-expand" aria-labelledby="offcanvasNavbar-expand" placement="end">
            <Offcanvas.Header className="mx-4" closeButton>
            ...
            <Offcanvas.Body className="px-4">
              <Nav className="justify-content-end flex-grow-1 pe-3" onSelect={(_, event) => { window.location.href = event.target.href; }} >
                <Button className=" px-md-3 call-button-all" href="tel:+1-714-724-8033">714.724.8033</Button>
                <Nav.Link className=" px-md-3 menu-link" href="#hospiceBasics">HOSPICE BASICS</Nav.Link>
                <Nav.Link className=" px-md-3 menu-link" href="#newInquiry">REFERRALS</Nav.Link>
                <Nav.Link className=" px-md-3 menu-link" href="#aboutUs">ABOUT US</Nav.Link>
              </Nav>
            </Offcanvas.Body>
          </Navbar.Offcanvas>
        </Container>
